...
struct UserLibraryView: View {
    ...
    @ObservedObject private var presenter: UserLibraryPresenter
    private var interactor: UserLibraryInteractorProtocol

    // MARK: - Init
    init(
        presenter: UserLibraryPresenter,
        interactor: UserLibraryInteractorProtocol
    ) {
